...
TCA 2. Finite ext. & Capacity bounds & PROVED & 1 corner \\
...
\bottomrule
\end{tabular}
\caption{Lean 4.29.1, mathlib v4.29.1.  11~theorems, 0~sorry in
QuantumAsTCA.  Certificate at \texttt{proof/certs/lean\_v0.2\_*.txt}.}
\end{table}

%%% ===================================================================
\section{Summary}

Two axioms. Eleven theorems. Three implications for physics:
