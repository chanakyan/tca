...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Theorem} & \textbf{Physics implication} & \textbf{Lean status} & \textbf{sorry?} \\
\midrule
1. Irreversibility & Second law / arrow of time & PROVED & none \\
2. Finite externalization & Capacity bounds & PROVED & 1 corner \\
3. Coupling & Entanglement structure & PROVED & none \\
4. Default as limit & Singularity characterization & PROVED & none \\
TSF Axiom 2 = Thm 1 & Irreversible time & PROVED & none \\
\bottomrule
\end{tabular}
\caption{Lean 4.29.1 + mathlib v4.29.1. Certificate at
\texttt{proof/certs/lean\_2026-04-21T23-10-31Z.txt}.}
\end{table}

%%% ===================================================================
\section{Summary}

Two axioms. Four theorems. Three implications for physics:
...
\item Quantum entanglement is TCA Theorem~3 on the probability
  substrate. Correlated outcomes are shared-reference coupling,
  not signals. Lean-verified.
...
The entire framework, from axioms to theorems to Lean proofs, is at
